...
const NewsLetter = () => {
    return (
        <section className='w-full py-[50px] px-12 mt-12 bg-secondary flex items-center gap-[50px] justify-center'>
            <img src='/aboutus-2.png' alt='image' className='w-[340px] rounded-[12px]'/>

            <div>
                <h1 className='text-[40px] font-[700] leading-[60px]'>Subscribe Our Newsletter</h1>
