...
const Testimonials = () => {
    ...
    return (
        <section className='w-full px-12 py-[50px]'>
            <h1 className='text-[40px] leading-[48px] font-[700] mb-[60px] text-center'>What our clients are saying</h1>

            <div style={{textAlign: "center"}} className="w-[50%] h-full mx-auto relative">
                <Swiper
                    rewind={true}
                    keyboard={{
                        enabled: true,
                ...
                {testimonialData && (
                    <div className='flex items-center gap-[20px]'>
                        <div ref={prevRef} className={`${swiperArrowStyles} testimonial-prev-slide absolute top-[110px] left-[-100px] hover:bg-primary hover:border-primary hover:text-white`}>
                            <BsChevronLeft size={24}/>
                        </div>
                        <div ref={nextRef} className={`${swiperArrowStyles} testimonial-next-slide absolute right-[-100px] top-[110px] hover:bg-primary hover:border-primary hover:text-white`}>
