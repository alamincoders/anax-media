...
const Contact = () => {
    return (
        <section className='w-full py-[50px] flex'>
            <div className='w-[50%] bg-[#FBFBFB] pr-[50px] py-[70px]'>
                <h1 className='text-[40px] font-[700] leading-[48px] text-center mb-[40px] mb-[20px]'>Get in Touch</h1>
                <form className='flex flex-col gap-[20px] w-[80%] mx-auto'>
            ...
            <iframe
                ...
                referrerPolicy="no-referrer-when-downgrade" className='w-[50%]'></iframe>
        </section>
    );
};
