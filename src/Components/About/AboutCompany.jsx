    ...
    return (
        <section className='w-full py-[60px]'>
            <div className='flex'>
                ...
                <article className=' p-[60px] flex flex-col justify-center'>
                    <h1 className='text-[40px] font-[700] leading-[60px]'>We’re experts at helping businesses reach
                        their true potential</h1>
                    <p className='text-[16px] font-[400] leading-[24px] text-[#585858] mt-[12px] mb-[10px] w-[80%]'>
                    ...
                    <p className='text-[16px] font-[400] leading-[24px] text-[#585858] mb-[10px] w-[80%]'>
                    ...
                    <p className='text-[16px] font-[400] leading-[24px] text-[#585858] w-[80%]'>We’re pretty good at
            ...
            <div className='flex mt-[110px]'>
                <article className='bg-[#FBFBFB] p-[60px] flex flex-col justify-center'>
                    <h1 className='text-[40px] font-[700] leading-[60px]'>Experienced experts are giving advices</h1>
                    <p className='text-[16px] font-[400] leading-[24px] text-[#585858] mt-[12px] mb-[10px] w-[80%]'>
            ...
            <div className='flex mt-[110px]'>
                <img src='/aboutus-4.png' alt='image' className='w-[700px]'/>
                <article className=' p-[60px] flex flex-col justify-center'>
                    <h1 className='text-[40px] font-[700] leading-[60px]'>Our Mission</h1>
                    <p className='text-[16px] font-[400] leading-[24px] text-[#585858] mt-[12px] mb-[10px] w-[80%]'>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat Lorem ipsum dolor sit amet, consectetur adipiscing elit, ullamco laboris nisi ut aliquip ex ea commodo consequat Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                    </p>
                </article>
            ...
            <div className='flex mt-[110px]'>
                <article className=' p-[60px] flex flex-col justify-center'>
                    <h1 className='text-[40px] font-[700] leading-[60px]'>Our Vision</h1>
                    <p className='text-[16px] font-[400] leading-[24px] text-[#585858] mt-[12px] mb-[10px] w-[80%]'>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat Lorem ipsum dolor sit amet, consectetur adipiscing elit, ullamco laboris nisi ut aliquip ex ea commodo consequat Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                    </p>
                </article>
